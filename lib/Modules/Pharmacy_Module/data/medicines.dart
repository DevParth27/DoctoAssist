...
List<MedicinedItem> MedicinedItems = [
  MedicinedItem(
    name: 'ASOZEN-TH',
    price: '₹100 /-',
    imagePath: 'assets/assets_pharmacy/medicines/ASOZEN-TH.jpg',
    description:
  ...
  MedicinedItem(
    name: 'Dolo 650',
    price: '₹28.90 /-',
    imagePath: 'assets/assets_pharmacy/medicines/Dola 650.jpeg',
    description:
  ...
  MedicinedItem(
    name: 'Sinarest',
    price: '₹99.98 /-',
    imagePath: 'assets/assets_pharmacy/medicines/sinarest.jpg',
    description:
  ...
  MedicinedItem(
    name: 'AMPICIX-500',
    price: '₹40 /-',
    imagePath: 'assets/assets_pharmacy/medicines/AMPICIX-500.jpg',
    description:
